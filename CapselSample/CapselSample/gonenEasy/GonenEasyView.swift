...
struct GonenEasyView: View {
    ...
    var body: some View {
        if manager.questionview == 1 {
            GonenQuestionView(viewModel: viewModel, questionNum: 2)
                .frame(height: phone.h*0.85)
        }else if manager.questionview == 3{
            GonenEasyClear(viewModel: viewModel, gonenn: gonenn, dataManeger: dataManeger)
            ...
            ZStack {
                ...
                Text("\(viewModel.mondainunnbetr)"+"/5")
